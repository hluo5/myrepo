...
params.add('b4', value=-21000)
#params.add('c4', value=-108, vary=False)
params.add('c4', value=0.0, vary=False)
params.add('hh', value=0.0, vary=False)
params.add('ho', value=0.0)
params.add('hmg', value=0.0, vary=False)
params.add('hsi', value=0.0)
params.add('oo', value=0.0, vary=False)
params.add('omg', value=-16.0)
params.add('osi', value=-4.0)
params.add('mgmg', value=0.0, vary=False)
params.add('mgsi', value=0.0, vary=False)
params.add('sisi', value=0.0, vary=False)
