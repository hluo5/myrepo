...
parser.add_argument("--infile",'-if', default='/u/project/ESS/lstixrud/jd848/metad/mgofe/inputs/mpmt/infile.py',help="infile.py to modify the plumed.dat and in.lammps")
parser.add_argument("--plumed",'-pf', default='/u/project/ESS/lstixrud/jd848/metad/mgofe/inputs/mpmt/plumed.dat',help="plumed.dat template file")
parser.add_argument("--lammps",'-lf', default='/u/project/ESS/lstixrud/jd848/metad/mgofe/inputs/mpmt/in.lammps',help="in.lammps template")
...
emin,emax,vmin,vmax = ys_sorted[2,0] -50, ys_sorted[2,0] +50, ys_sorted[3,0] -50, ys_sorted[3,0] +50
pmin,pmax,tmin,tmax = args.ptarget - 20, args.ptarget +20,  args.ttarget -1000, args.ttarget +1000
print('v',vmin,vmax)
